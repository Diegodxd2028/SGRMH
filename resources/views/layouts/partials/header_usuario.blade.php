    ...
    <nav class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <div class="hidden md:flex space-x-6 items-center">
                ...
                <a href="{{ route('campañas.index') }}" class="{{ request()->routeIs('campañas.index') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-500' }}">Campañas</a>
        ...
        <div x-show="open" class="md:hidden mt-2 pb-4 space-y-2" x-transition>
            ...
            <a href="{{ route('campañas.index') }}" class="block px-4 py-2 {{ request()->routeIs('campañas.index') ? 'text-green-600 font-semibold' : 'text-gray-700 hover:text-green-500' }}">Campañas</a>
